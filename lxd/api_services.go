...
func servicePost(d *Daemon, r *http.Request) response.Response {
	...
	if req.Type == api.TypeLXDCluster.String() {
		if req.IdentityName == "" {
	...
	} else if req.Type == api.TypeLXDImageServer.String() {
		// TODO: Implement image server service join.
		return nil
	} else if req.Type == api.TypeS3.String() {
		// TODO: Implement S3 service join.
		return nil
	} else if req.Type == api.TypeClusterManager.String() {
		// TODO: Implement cluster manager service join.
		return nil
	}
