...
During refresh, the server applies the target instance configuration from the request (including config, devices, and profiles) after data transfer completes.
